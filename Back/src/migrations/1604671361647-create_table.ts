...
export class createTable1604671361647 implements MigrationInterface {
    name = 'createTable1604671361647'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `convocation` (`id` int NOT NULL AUTO_INCREMENT, `num_register` int NOT NULL, `name_pers_conv` varchar(255) NOT NULL, `convoke_on` datetime NOT NULL, `at_town` varchar(255) NOT NULL, `at_time` varchar(255) NOT NULL, `num_requisition` varchar(255) NOT NULL, `folder_id` int NULL, `num_pv` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `letter` (`id` int NOT NULL AUTO_INCREMENT, `num_rtx` varchar(255) NOT NULL, `date_rtx` datetime NOT NULL, `letter_town` varchar(255) NOT NULL, `object` varchar(255) NOT NULL, `folder_id` int NULL, UNIQUE INDEX `REL_dfa8d9ecf76500531ee6ad54e3` (`folder_id`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
