<template>
  <div class="">
    <q-editor
      ...
      max-height="297mm"
      v-model="content"
      @keyup="$emit('contentChange', content)"
      :dense="$q.screen.lt.md"
      :ref="'editor_' + editorName"
...
export default defineComponent({
  ...
  setup: (props) => {
    ...
    function emitContent(val: any) {
      console.log(val);
    }

    function add(name: string, token: string) {
      const edit = this.$refs['editor_' + props.editorName];
