  ...
  <div style="position: relative" class="container">
    ...
    >
      ...
      <q-card-section horizontal class="full-width">
        <q-card flat bordered class="border" style="width: 100%">
    ...
    >
      <q-card-section horizontal class="full-width no-padding">
        <q-card flat style="width: 100%">
          <q-card-section class="no-padding" v-html="model" />
        </q-card>
      </q-card-section>
    </q-card>

    <!-- lOADING STATE -->
    <q-card v-if="loading" flat bordered style="padding: 5px; padding-top: 2px">
