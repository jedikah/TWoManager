...
module.exports = {
  ...
  Mutation: {
    addMOE: async (_, args, context) => {
      ...
      const person = await model.personne.create(args.personneInfo);

      const moe = await model.moe.create({
      ...
      const avantages = args.avantages ? args.avantages : [];
    ...
    updateMOE: async (_, args, context) => {
      ...
      const person = await model.personne.findOne({
        where: {
          IdPersonne: args.IdMOE
        },
        raw: true
      ...
      const moe = await model.moe.findOne({
        raw: true,
        where: {
          IdPersonne: args.IdMOE
        }
