...
module.exports = {
  Query: {
    menage: async (_, args, context) => {
      ...
      const res = await model.menage.findOne({
        raw: true,
        where: {
  ...
  Mutation: {
    addMenage: async (_, args, context) => {
      ...
      const person = await model.personne.create(
        args.InfoMenage.details_personne
      );
      ...
      const menage = await model.menage.create(args.InfoMenage);
    ...
    addAssociationToMenage: async (_, args, context) => {
      ...
      const assoc = await model.etre_membre.create(
        { IdAssoc: args.IdAssoc, IdPersonne: args.IdPersonne },
        {
          raw: true,
          plain: true
        }
    ...
    updateAssociationOfMenage: async (_, args, context) => {
      ...
      await model.etre_membre.update(
        { actif: args.actif },
        {
          raw: true,
          plain: true,
